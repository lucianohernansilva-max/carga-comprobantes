...
const TIPOS_PREDEFINIDOS = [
  ...
  },
  {
    ...
    descripcion: 'Anticipos de Ganancias PJ según cierre de ejercicio',
    periodicidad: 'anual',
    patron: PATRONES.PATRON_DIAS_CIERRE,
    configuracion: { mesesDespues: 2 },
    activo: true, esCustom: false,
    condicionesFiscales: ['responsable_inscripto'],
  ...
  },
  {
    ...
    descripcion: 'Declaración jurada anual de Ganancias, personas humanas',
    periodicidad: 'anual',
    patron: PATRONES.PATRON_SEMESTRAL_FIJO,
  ...
  },
  {
    ...
    periodicidad: 'anual',
    patron: PATRONES.PATRON_DIAS_CIERRE,
    configuracion: { mesesDespues: 5, tablaKey: 'iva' },
    activo: true, esCustom: false,
    condicionesFiscales: ['responsable_inscripto'],
    tiposPersona: ['juridica'],
  },
